    ...
    return (
        <div className="job-apply-container">
            ...
            <div className="input-group mb-3">
                ...
                <input type="text" className="form-control" aria-label="Phone number" placeholder="Phone number" />
            </div>
            <label for="basic-url" className="form-label">Email</label>
            <div className="input-group mb-3">
                <input type="email" className="form-control" placeholder="Email" aria-label="First name" />
            </div>
            <label for="basic-url" className="form-label">Upload resume/cover letter</label>
            <div className="input-group mb-3">
